        ...
        <section id="contact" className="flex flex-col items-center text-center w-full mt-10 scroll-mt-32">
            <div className="glass w-full max-w-[1200px] rounded-[3rem] p-12 md:p-16 flex flex-col items-center border-slate-700/50 bg-slate-800/40 shadow-2xl relative overflow-hidden">
                ...
                <div className="flex flex-wrap justify-center gap-6 w-full mt-2 z-10">
                    ...
                    {/* Phone */}
                    <a href={`tel:${hero.phone}`} className="flex-1 min-w-[200px] max-w-[250px] group flex flex-col items-center justify-center gap-4 bg-slate-900/60 p-8 rounded-3xl border border-slate-700/50 hover:border-emerald-500/50 hover:-translate-y-2 transition-all duration-300 hover:shadow-[0_10px_30px_rgba(16,185,129,0.1)]">
                        ...
                        <div className="flex flex-col gap-1 items-center">
                            ...
                            <span className="text-sm text-slate-400 group-hover:text-emerald-300 transition-colors">{hero.phone}</span>
                        </div>
                    </a>

                    {/* Email */}
                    <a href={`mailto:${hero.email}`} className="flex-1 min-w-[200px] max-w-[250px] group flex flex-col items-center justify-center gap-4 bg-slate-900/60 p-8 rounded-3xl border border-slate-700/50 hover:border-sky-500/50 hover:-translate-y-2 transition-all duration-300 hover:shadow-[0_10px_30px_rgba(14,165,233,0.1)]">
