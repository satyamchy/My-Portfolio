  ...
  return text
    ...
    return (
        <div className="fixed bottom-6 right-6 z-[100] flex flex-col items-end">
            ...
            <div className="flex items-center gap-3 relative group/tooltip mt-2">
                {!isOpen && (
                    <div className="absolute right-[110%] mr-2 whitespace-nowrap bg-slate-900/90 backdrop-blur-sm border border-slate-700/50 text-slate-300 text-sm font-medium px-4 py-2 rounded-full shadow-lg opacity-100 transition-opacity">
                        Ask about Satyam
                    </div>
                )}
                <button
